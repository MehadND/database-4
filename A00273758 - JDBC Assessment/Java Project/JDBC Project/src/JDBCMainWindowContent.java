...
public class JDBCMainWindowContent extends JInternalFrame implements ActionListener, MouseListener
{
    ...
    JFrame nationalitiesFrame = new JFrame();
    JFrame goalsFrame = new JFrame();

    JFreeChart nationalitiesChart = null;
    JFreeChart goalsChart = null;
...
//                TitledBorder.CENTER, TitledBorder.CENTER, null, Color.red)));
    ...
    public void openNationalitiesPerClubChart() throws SQLException, IOException
    {
        ...
        nationalitiesChart = ChartFactory.createPieChart(
        ...
        nationalitiesFrame.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent windowEvent) {
                ...
                int userSelection = fileChooser.showSaveDialog(nationalitiesFrame);
                ...
                if (userSelection == JFileChooser.APPROVE_OPTION) {
                    ...
                    try
                    {
                        ChartUtilities.saveChartAsJPEG(fileToSave, nationalitiesChart, width, height);    // saves chart as jpeg file
                    } catch (IOException e)
                    {
...
//        PieSectionLabelGenerator labelGenerator = new StandardPieSectionLabelGenerator("{0} = {1}");
        goalsChart = ChartFactory.createPieChart3D(
                "Goals Per Age",   // chart title
                dataset,          // data
                true,             // include legend
                true,
                false);
        ChartPanel chartPanel = new ChartPanel(goalsChart);
        ...
        goalsFrame.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent windowEvent) {
                ...
                fileChooser.setAcceptAllFileFilterUsed(true);
                int userSelection = fileChooser.showSaveDialog(goalsFrame);
                ...
                if (userSelection == JFileChooser.APPROVE_OPTION) {
                    ...
                    try
                    {
                        ChartUtilities.saveChartAsJPEG(fileToSave, goalsChart, width, height);    // saves chart as jpeg file
                    } catch (IOException e)
                    {
                        throw new RuntimeException(e);
                    }
